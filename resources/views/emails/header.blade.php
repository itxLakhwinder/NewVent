...
<body style="margin:0px;background:#f1f1f1;padding:40px 0  40px 0;">
	<div class="container">
		<div class="header-section" style="text-align:center;width:74%;margin:0px auto;padding:8px 0px 8px 0">
			<img alt="" src="https://login.ventspaceapp.com/partner_assets/images/logo.png" style="width:100px;" />			
		</div>
